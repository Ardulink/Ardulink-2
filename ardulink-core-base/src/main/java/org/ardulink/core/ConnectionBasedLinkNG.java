...
import static org.ardulink.core.ConnectionBasedLinkNG.Mode.ANY_MESSAGE_RECEIVED;
 ...
 *
 */
public class ConnectionBasedLinkNG extends AbstractListenerLink implements CBL {

	private static final Logger logger = LoggerFactory.getLogger(ConnectionBasedLinkNG.class);
