...
This sketch is for Digispark that doesn't support Serial library. Actually it manages
ALProtocol (without responses from Digispark) but just for PIN Power Switch messages.
If you have different needs you have to modify this sketch accordingly.

Remember: Digispark has just 6.012 bytes memory available for sketches.
