 ...
 *
 */
public final class AttributeFinders {

	private AttributeFinders() {
		super();
	}

	private static final FindByIntrospection findByIntrospection = new FindByIntrospection();
	private static final FindByFieldAccess findByFieldAccess = new FindByFieldAccess();

	public static AttributeFinder beanAttributes() {
		return findByIntrospection;
	}

	public static AttributeFinder directFieldAccess() {
		return findByFieldAccess;
	}
